...
from file_to_array import train_30s, test_30s, train_10s, test_10s, train_5s, test_5s, mahalanobis_distance, cov_matrix_30s
...
def k_NN_classifier(train_set,test_set,k):
    ...
    for i in range(len(test_set[0])):
        ...
        for j in range(len(train_set[0])):
            ...
            #distance = mahalanobis_distance(test_features, train_features, cov_matrix_30s)
...
error_rate, cm, labels, predictions = evaluating_k_NN_classifier(train_30s, test_30s, k)
